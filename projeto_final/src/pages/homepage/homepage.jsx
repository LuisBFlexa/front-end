export default function Homepage() {
    return( 
        ...
        <main className=" bg-[#F0EFEF]">
            ...
            <h1 className=" flex justify-center mt-14 text-transparent bg-clip-text bg-gradient-to-r to-[#001971] from-[#c4c4c4]  tracking-wider font-bold font-serif text-4xl">CATEGORIAS</h1>
            <div className=" flex md:flex-wrap justify-center space-x-60 mt-20 ">
